<div class="modal fade" id="getQuoteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Get Quote Form') }}</h5>
            ...
            <div class="modal-body">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form
                                action="{{ route('frontend.space.booking.get_quote_info', ['slug' => request()->route('slug')]) }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group mb-20">
                                            ...
                                            <input type="hidden" name="get_quote_form_id"
                                                value="{{ @$spaceContent->get_quote_form_id }}">
                                            <input type="hidden" name="space_id"
                                                value="{{ @$spaceContent->space_id }}">
                                            <input type="hidden" name="seller_id"
                                                value="{{ @$spaceContent->seller_id }}">
                                            <input type="hidden" name="form_type" value="{{ 'getQuoteModal' }}">
                                            <label for="name"
