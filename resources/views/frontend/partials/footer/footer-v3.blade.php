...
@php
$footerTextColor = $footerInfo?->footer_background_color ?? '';
@endphp

<!-- Footer-area start -->
<footer class="footer-area footer-area_v2 bg-img bg-cover border-top"
            ...
            <div class="row gx-xl-5 justify-content-between">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="footer-widget" data-aos="fade-up">
                        ...
                        @endif
                        <form id="newsletterForm" action="{{ route('store.subscriber') }}" class="subscription-form"
                            method="POST">
                            @csrf
                            <div class="input-inline p-1 bg-white shadow-md radius-sm">
                                <input class="form-control border-0" placeholder="{{ __('Email Address') }}"
                                    type="text" name="email_id" required>
                                <button class="btn btn-md btn-primary radius-sm" type="submit" aria-label="button">{{
                                    __('Subscribe') }}</button>
                            </div>
                        </form>
                    </div>
