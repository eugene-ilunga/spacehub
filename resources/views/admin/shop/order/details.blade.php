...
@section('content')
    ...
    <div class="text-right mb-3">
        <a href="{{ route('admin.shop_management.orders') }}?language={{ $defaultLang->code }}"
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-inline-block">
                        {{ __('Order Number') . ' ' . '#' . $details->order_number }}
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="payment-information">
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-6">
                                @if ($details->created_at)
                                    {{ \Carbon\Carbon::parse($details->created_at)->timezone($adminTimezone)->format('M d, Y') }}
                                @endif
                            </div>
                        </div>
                        ...
                        @if ($details->discount > 0)
                            <div class="row mb-2">
                                <div class="col-lg-6">
                                    <strong>{{ __('Discount') }} <span class="text-success">(<i
                        ...
                        @if ($details->shipping_cost > 0)
                            <div class="row mb-2">
                                <div class="col-lg-6">
                                    <strong>{{ __('Shipping Cost') }} <span class="text-danger">(<i
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                <strong>
                                    ...
                                    <span class="text-danger">(<i class="far fa-plus"></i>)</span> :
                                </strong>
                            </div>
