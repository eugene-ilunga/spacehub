                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control h-42" name="payment_gateway">
                                                <option value=""
                                                    {{ empty(request()->input('payment_gateway')) ? 'selected' : '' }}>
                                                    {{ __('All') }}
                                                </option>
                                        ...
                                        <tbody>
                                            @foreach ($orders as $order)
                                                <tr>
                                                    ...
                                                    <td>{{ is_null($order->billing_state) ? '-' : $order->billing_state }}
                                                    </td>
                                                    ...
                                                    <td>{{ is_null($order->shipping_state) ? '-' : $order->shipping_state }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif ($order->order_status == 'processing')
                                                            <span
                                                                class="badge badge-primary">{{ __('Processing') }}</span>
