        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row justify-content-center align-items-end"> <!-- Center alignment -->
                        <div class="col-lg-10 col-md-12">
                            <form id="searchForm" action="{{ route('admin.shop_management.orders') }}" method="GET">
                                ...
                                <div class="form-row justify-content-center"> <!-- Center form fields -->
                                    <!-- Order Number Search - Increased width -->
                                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2"> <!-- Changed from col-lg-2 to col-lg-3 -->
                                        <div class="form-group mb-0">
                                            <label class="font-weight-bold small">{{ __('Order Number') }}</label>
                                    ...
                                    <!-- Payment Status Filter - Increased width -->
                                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2"> <!-- Changed from col-lg-2 to col-lg-3 -->
                                        <div class="form-group mb-0">
                                            <label class="font-weight-bold small">{{ __('Payment Status') }}</label>
                                            <select class="form-control" name="payment_status"
                                                onchange="this.form.submit()">
                                                <option value="">{{ __('All Payments') }}</option>
                                                <option value="completed" @selected(request('payment_status') == 'completed')>
                                                    {{ __('Completed') }}
                                                </option>
                                                <option value="pending" @selected(request('payment_status') == 'pending')>
                                                    {{ __('Pending') }}
                                                </option>
                                                <option value="rejected" @selected(request('payment_status') == 'rejected')>
                                                    {{ __('Rejected') }}
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <!-- Order Status Filter - Increased width -->
                                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2"> <!-- Changed from col-lg-2 to col-lg-3 -->
                                        <div class="form-group mb-0">
                                            <label class="font-weight-bold small">{{ __('Order Status') }}</label>
                                            <select class="form-control" name="order_status" onchange="this.form.submit()">
                                                <option value="">{{ __('All Orders') }}</option>
                                                <option value="pending" @selected(request('order_status') == 'pending')>
                                                    {{ __('Pending') }}
                                                </option>
                                                ...
                                                <option value="rejected" @selected(request('order_status') == 'rejected')>
                                                    {{ __('Rejected') }}
                                                </option>
                                            </select>
                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a href="{{ route('admin.shop_management.order.details', ['id' => $order->id]) }}?language={{ $defaultLang->code }}"
                                                                    class="dropdown-item">
                                                                    {{ __('Details') }}
                                                                </a>
