          ...
          <div class="row no-gutters">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" id="in_start_date" class="form-control checkInDateNotBooking" name="start_date"
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" id="in_end_date" class="form-control checkInDateNotBooking" name="end_date"
