                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-4 col-12 mb-2 mb-lg-0">
                            <h4 class="card-title d-inline-block mb-0">{{ __('Coupons') }}</h4>
                        </div>

                        <!-- Search Form Column -->
                        <div class="col-lg-4 col-md-5 col-12 mb-2 mb-md-0">
                            <form action="{{ route('admin.shop_management.coupons') }}" method="GET">
                                <div class="input-group">
                                    <input name="name" type="text" class="form-control border-right-0"
                                        placeholder="{{ __('Search coupons by name') . '...' }}"
                                        value="{{ request('name') }}" aria-label="Search coupons">
                        ...
                        <!-- Add Button Column -->
                        <div class="col-lg-4 col-md-3 col-12 text-lg-right text-md-right text-left">
