                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-4 mb-3 mb-md-0">
                            <h4 class="card-title mb-0">{{ __('Shipping Charges') }}</h4>
                        </div>

                        <!-- Search Form Column -->
                        <div class="col-lg-5 col-md-6 mb-2 mb-md-0">
                            <form action="{{ route('admin.shop_management.shipping_charges') }}" method="GET">
                                <div class="input-group">
                                    <input name="title" type="text" class="form-control border-right-0"
                                        placeholder="{{ __('Search shipping by title') . '...' }}"
                                        value="{{ request('title') }}" aria-label="Search shipping charges">
                        ...
                        <div class="col-lg-3 col-md-2">
                            <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-primary btn-sm float-right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary btn-sm mr-1  mt-1 btn-sm editBtn"
                                                            ...
                                                            data-short_text="{{ $charge->short_text }}"
