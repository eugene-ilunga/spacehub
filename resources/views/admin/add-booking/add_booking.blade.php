                ...
                <div class="col-xl-12">
                    <aside class="widget-area" data-aos="fade-up">
                        <div class="widget widget-booking ">
                            <form action="{{ route('admin.confirm.booking', ['slug' => request()->slug]) }}" method="POST"
                                            ...
                                            @else
                                                ...
                                                @if (isset($space) && optional($space)->space_type == 1)
                                                    <div class="form-group date-form p-0 " >
                                                        ...
                                                        <select class="form-control mdb_343 select2" dir="ltr" name="eventTime"
                                                            id="eventTime">
                                                                                    ...
                                                                                    <div class="addons_card_list">
                                                                                        <div class="card bg-none mb-10">
                                                                                            ...
                                                                                            <div class="card_content">
                                                                                                ...
                                                                                                <p
                                                                                                    class="serviceStagePrice card_text font-sm" dir="ltr">
                                        ...
                                        <div class="border p-20">
                                            <div class="widget widget-select mb-20">
                                                ...
                                                <ul class="list-group pb-20">
                                                    ...
                                                    @if (isset($spaceContent) &&
                                                        ...
                                                        <li id="spaceRent">
                                                            ...
                                                            {{ @$spaceContent->space_rent }}"
                                                                class="h6 mb-0 spaceRent ltr">{{ $position == 'left' ? $symbol : '' }}{{ @$spaceContent->space_rent }}{{ $position == 'right' ? $symbol : '' }}</span>
                                                        </li>
                                                    @endif
                                                    ...
                                                    <li id="subTotalAmount">
                                                        ...
                                                        <span class="h6 mb-0 color-primary subTotalAmount ltr">
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="h6 mb-0 ltr" id="vatAmountSpan">
                                                            {{ $position == 'left' ? $symbol : '' }}
                                                    ...
                                                    <li id="TotalAmount">
                                                        ...
                                                        <span id="totalAmount" class="h6 mb-0 color-primary totalAmount ltr">
                                                            {{ $position == 'left' ? $symbol : '' }}
                                            ...
                                            <div class="form-group p-0">
                                                ...
                                                <input type="text" id="spaceDiscount" class="form-control"
                                                    name="space_discount" placeholder="{{ __('Enter Discount') }}"
                                                    value="">
                                            </div>
                                            <div class="form-group p-0">
...
@section('script')
    <script>
        ...
        var getTimeSlotUrl = "{{ route('admin.booking.get_time_slot') }}";
        ...
        var translations = {
            ...
            fullName: "{{ __('The customer name is required') . '.' }}",
            customerPhoneNumber: "{{ __('The customer phone number is required') . '.' }}",
            customerEmailAddress: "{{ __('The customer email is required') . '.' }}",
        };
