                ...
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block"
                        ...
                        <span class="btn-label">
                            <i class="fas fa-backward mdb_24234"></i>
                        </span>
                        {{ __('Back') }}
                    </a>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form id="postForm" action="{{ route('admin.blog_management.store_post') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-warning small mt-2">                                   {{ '*' . __('Recommended Image Size') . ':' }} <strong dir="ltr">750×500 px</strong></p>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                                        ...
                                                        <div class="col">
                                                            <div
                                                                ...
                                                                <textarea  class="form-control summernote" name="{{ $language->code }}_content"
                                                                    placeholder="{{ __('Enter Post Content') }}" data-height="300"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
