                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            <a href="{{ route('admin.announcement_popups.select_popup_type') }}?language={{ $defaultLang->code }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form id="statusForm-{{ $popup->id }}" class="d-inline-block"
                                                            action="{{ route('admin.announcement_popups.update_popup_status', ['id' => $popup->id, 'language' => $defaultLang->code]) }}"
                                                            method="post">
                                                            @csrf
                                                            <select
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary btn-sm mr-1 mb-1"
                                                            href="{{ route('admin.announcement_popups.edit_popup', ['id' => $popup->id, 'language' => $defaultLang->code]) }}">
                                                            <span class="btn-label">
                                                                <i class="fas fa-edit mdb_31321"></i>
                                                            </span>
                                                        </a>
                                                        ...
                                                        <form class="deleteForm d-inline-block"
                                                            ...
                                                            <button type="submit"
                                                                ...
                                                                <span class="btn-label">
                                                                    <i class="fas fa-trash mdb_31321"></i>
                                                                </span>
                                                            </button>
                                                        </form>
                                                    </td>
