            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block"
                        href="{{ route('admin.announcement_popups.select_popup_type', ['language' => $defaultLang->code]) }}">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <p class="text-warning mt-2 mb-0">
                                                <small>{{ __('This name will not appear in UI') . '. '.__('Rather then') . ', '. __('it will help the admin to identify the popup') . '.' }}</small>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control checkInDateNotBooking" name="end_date"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <p class="mt-2 mb-0 text-warning">
                                                {{__('If there are multiple active popups') . ', ' .__('then popups will be shown in UI according to serial number') . '.' }}
                                                <br>
