...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Registered Staffs') }}</h4>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary btn-sm mr-1 editBtn mb-1" href="#"
                                                            ...
                                                            <span class="btn-label">
                                                                <i class="fas fa-edit mdb_32342"></i>
                                                            </span>
                                                        </a>
                                                        ...
                                                        <form class="deleteForm d-inline-block"
                                                            ...
                                                            <button type="submit"
                                                                ...
                                                                <span class="btn-label">
                                                                    <i class="fas fa-trash mdb_32342"></i>
                                                                </span>
                                                            </button>
                                                        </form>
                                                    </td>
