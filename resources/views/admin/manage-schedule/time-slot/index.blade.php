    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                @if (isset($days) && $days->isEmpty())
                    <h3 class="text-center mt-2">{{ __('NO DAYS FOUND') . '!' }}</h3>
                @else
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                            ...
                                            @foreach ($days as $day)
                                                <tr>
                                                    ...
                                                    @else
                                                        <td>
                                                            <form
                                                                action="{{ route('admin.manage_schedule.time_slot.manage_time_slot', ['dayId' => $day->id, 'spaceId' => $space_id]) }}"
                                                                method="get">
                                                                @csrf
