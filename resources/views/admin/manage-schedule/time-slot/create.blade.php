<div class="modal fade time_slot_modal" id="createModal" tabindex="-1" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Time Slot') }}</h5>
            ...
            <div class="modal-body">
                <form autocomplete="off" id="ajaxForm" class="modal-form create"
                    action="{{ route('admin.manage_schedule.time_slot.store') }}" method="post">
                    @csrf
                        ...
                        <div class="col-lg-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="start_time" class="form-control time-24slot ltr"
                                    title="{{ __('Show time picker') }}" placeholder="{{ __('Choose Start Time') }}"
                                    id="in_start_time">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="end_time" class="form-control time-24slot ltr"
                                    title="{{ __('Show time picker') }}" placeholder="{{ __('Choose End Time') }}"
                                    id="in_end_time">
                        ...
                        <div class="{{ $isShowTimeSlotRent ? 'col-lg-6' : 'col-lg-12' }}">
                            <div class="form-group">
                                ...
                                <input type="number" name="number_of_booking" class="form-control"
                                    placeholder="{{ __('Enter number of booking') }}" id="in_number_of_space">
                                <p id="err_number_of_booking" class="mt-1 mb-0 text-danger em"></p>
