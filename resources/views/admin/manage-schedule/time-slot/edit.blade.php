        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form autocomplete="off" id="ajaxEditForm" class="modal-form"
                    action="{{ route('admin.manage_schedule.time_slot.update') }}" method="post">
                    @csrf
                        ...
                        <div class="col-lg-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="start_time" class="form-control time-24slot ltr"
                                    placeholder="{{ __('Choose Start Time') }}" title="{{ __('Show time picker') }}"
                                    id="in_start_time">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="end_time" class="form-control time-24slot ltr"
                                    placeholder="{{ __('Choose End Time') }}" title="{{ __('Show time picker') }}"
                                    id="in_end_time">
