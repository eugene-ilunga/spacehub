                    ...
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            <div class="alert alert-warning" role="alert">
                                <span class="text-warning">{{ __('Cron Job Command') . ': ' }}</span> </br> <code>Curl -sS {{ route('cron.expired') }}</code> <span class="text-warning">{{'('. __('Run daily at midnight') . ')' }}</span> </br>
                                <span class="text-warning">{{ __('Purpose') . ':' }}</span> </br>
                                <span class="text-warning">{{ __('Alerts vendors when their subscriptions are nearing expiration or expire') . '. ' . __("Without this cron job, emails won’t send") . '.' }}</span>
                            </div>
                                ...
                                <div id="recurringBilling">
                                    <div class="form-group">
                                        ...
                                        <p class="text-warning mb-0">
                                            {{ __('Specify how many days before you want to remind your customers about subscription expiration'). '. '. __('(via mail)') }}
                                        </p>
                                    </div>
                                </div>
                            </form>
