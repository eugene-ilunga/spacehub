                            ...
                            <div class="card border-primary mb-3">
                                ...
                                <div class="card-body">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            {{ __('Spaces') }} <a href="" data-text="{{ __('Spaces') }}"
                                                data-type="spaces"
                                                class="addToMenus btn btn-primary btn-sm float-right">{{ __('Add To Menus') }}</a>
                                        </li>
                                        ...
                                        <li class="list-group-item">
                                            {{ __('Shop') }} <a href="" data-text="{{ __('Shop') }}"
                                                data-type="shop"
                                                class="addToMenus btn btn-primary btn-sm float-right">{{ __('Add To Menus') }}</a>
                                        </li>
                                        <li class="list-group-item">
                                            {{ __('Product') }} <a href="" data-text="{{ __('Product') }}"
                                                data-type="product"
                                                class="addToMenus btn btn-primary btn-sm float-right">{{ __('Add To Menus') }}</a>
                                        </li>

                                        <li class="list-group-item">
                                            {{ __('Cart') }} <a href="" data-text="{{ __('Cart') }}"
                                                data-type="cart"
                                                class="addToMenus btn btn-primary btn-sm float-right">{{ __('Add To Menus') }}</a>
                                        </li>
                                        <li class="list-group-item">
                                            {{ __('Checkout') }} <a href="" data-text="{{ __('Checkout') }}"
                                                data-type="checkout"
                                                class="addToMenus btn btn-primary btn-sm float-right">{{ __('Add To Menus') }}</a>
                                        </li>
                                        ...
                                        <li class="list-group-item">
                                            {{ __('Pages') }} <a href="" data-text="{{ __('Pages') }}"
                                                data-type="pages"
                                                class="addToMenus btn btn-primary btn-sm float-right">{{ __('Add To Menus') }}</a>
                                        </li>
                                    ...
                                    <form id="menu-builder-form" class="form-horizontal">
                                        ...
                                        <div id="withUrl">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="url" class="form-control item-menu" name="href"
                                        ...
                                        <div id="withoutUrl" class="mdb_display_none">
                                            <div class="form-group">
                                                <label for="text">{{ __('Text') }}</label>
                                                <input type="text" class="form-control item-menu" name="text"
                                                    placeholder="{{ __('Enter Menu Name') }}">
