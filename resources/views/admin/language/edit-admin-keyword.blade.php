        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="#" class="btn btn-sm btn-primary float-right d-inline-block ml-2" data-toggle="modal" data-target="#adminAddModal">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="languageKeywordForm"
                                action="{{ route('admin.language_management.admin.update_keyword', ['id' => $language->id]) }}"
                                method="post">
                                @csrf
                                <div class="row">
                                    @foreach ($keywords as $keyword => $value)
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                <label class="control-label mdb_normal_space">
                                                    {{ $keyword }}
                                                </label>
