...
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between ">
                    ...
                    <div>
                        <a href="#" class="btn btn-sm btn-primary " data-toggle="modal" data-target="#adminAddModal">
                            <i class="fas fa-plus"></i> {{ __('Add Admin Language Keyword') }}
                        </a>
                        <a href="#" class="btn btn-sm btn-info " data-toggle="modal" data-target="#addModal">
                            <i class="fas fa-plus"></i> {{ __('Add Frontend Language Keyword') }}
                        </a>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <form class="d-inline-block"
                                                                action="{{ route('admin.language_management.make_default_language', ['id' => $language->id, 'language' => $defaultLang->code]) }}"
                                                                method="post">
                                                                @csrf
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.language_management.admin.edit_keyword', [$language->id, 'language' => $defaultLang->code]) }}">
                                                                    {{ __('Edit Admin Keyword') }}
                                                                </a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.language_management.edit_keyword', [$language->id, 'language' => $defaultLang->code]) }}">
    ...
    @include('admin.language.add-language-admin-keyword')
    @include('admin.language.add-language-keyword')

    {{-- edit modal --}}
    @include('admin.language.edit')
@endsection
@section('script')
    <script src="{{ asset('assets/admin/js/admin-submit-button.js') }}"></script>
    <script src="{{ asset('assets/admin/js/front-submit-button.js') }}"></script>
@endsection
