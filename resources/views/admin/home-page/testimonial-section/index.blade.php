...
@section('content')
                        ...
                        <div class="col">
                            ...
                            @else
                                <div class="table-responsive">
                                    <table class="table testimonial-section-table table-striped mt-3" id="basic-datatables">
                                        <thead>
                                            <tr>
                                                <th scope="col">
    ...
    {{-- create modal --}}
    @includeIf('admin.home-page.testimonial-section.create')

    {{-- edit modal --}}
    @includeIf('admin.home-page.testimonial-section.edit')
@endsection
