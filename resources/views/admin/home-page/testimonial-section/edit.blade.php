                    ...
                    <div class="form-group">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="text-warning small mt-2">
                                {{ '*' . __('Recommended Image Size') . ':' }} <strong dir="ltr">300×470 px</strong>
                            </p>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name"
                                    placeholder="{{ __('Enter Client Name') }}" id="in_name">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="occupation"
                                    placeholder="{{ __('Enter Client Occupation') }}" id="in_occupation">
