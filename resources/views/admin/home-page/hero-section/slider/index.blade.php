...
@section('content')
                                ...
                                <div class="row">
                                    @foreach ($sliders as $slider)
                                        <div class="col-md-3">
                                            <div class="card">
                                                <div class="card-body">
                                                    <img src="{{ asset('assets/img/hero-sliders/' . $slider->image) }}"
                                                        alt="image" class="mdb_100">
                                                </div>
                                                ...
                                                <div class="card-footer text-center">
                                                    ...
                                                    <form class="deleteForm d-inline-block"
                                                        action="{{ route('admin.home_page.delete_slider', ['id' => $slider->id]) }}"
                                                        method="post">
                                                        @csrf
    ...
    {{-- create modal --}}
    @includeIf('admin.home-page.hero-section.slider.create')
