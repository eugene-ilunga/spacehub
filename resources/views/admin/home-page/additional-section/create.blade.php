                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 m-auto">
                            ...
                            <form id="pageForm" action="{{ route('admin.home_page.additional_section.store') }}"
                                method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group p-0">
                                            ...
                                            <select name="position" class="form-control select2">
                                                ...
                                                @foreach ($positions as $value => $labelKey)
                                                    <option value="{{ $value }}">{{ __($labelKey) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group p-0">
                                            <label for="">{{ __('Serial Number') }} <span
                                                    class="text-danger">**</span></label>
                                            <input type="number" name="serial_number" class="form-control" placeholder="{{ __('Enter Serial Number') }}">
                                    ...
                                    @foreach ($languages as $language)
                                        <div class="version {{ $language->direction == 1 ? 'rtl' : 'ltr' }}">
                                            <div class="version-header" id="heading{{ $language->id }}">
                                                <h5 class="mb-0">
                                                    <button type="button" class="btn btn-link {{ $language->direction == 1 ? 'rtl text-right' : 'ltr' }}" data-toggle="collapse"
