        ...
        <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.home_page.update_feature') }}" method="post">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="jscolor form-control" name="color" id="in_color">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="description" placeholder="{{ __('Enter description') }}" id="in_description">
            <p id="editErr_description" class="mt-2 mb-0 text-danger em"></p>
          </div>
          <div class="form-group">
            <label for="">{{ __('Number') . '*' }}</label>
            <input type="number" class="form-control" name="number" placeholder="{{ __('Enter number') }}" id="in_number">
            <p id="editErr_number" class="mt-2 mb-0 text-danger em"></p>
          </div>
        </form>
      </div>
