    ...
    <table class="table table-striped mdb_242">
        ...
        <tbody>
            ...
            @if ($templateInfo->mail_type == 'add_user_by_admin')
                ...
                <tr>
                    <td>{user_type}</td>
                    <td scope="row">{{ __('Customer / Vendor') }}</td>
                </tr>
                <tr>
                    <td>{password}</td>
                    <td scope="row">{{ __('Password of Cutomer/Vendor') }}</td>
                </tr>
            @endif
            @if ($templateInfo->mail_type == 'multiday_rental_space_booking')
                <tr>
                    <td>{customer_name}</td>
                ...
                <tr>
                    ...
                    <td>{{ __('Booking Reference Number or Booking ID') }}</td>
                </tr>
                <tr>
                    <td>{start_date}</td>
                    <td>{{ __('Start Date of the Booking for multi-day bookings') }}</td>
                </tr>
                <tr>
                    <td>{end_date}</td>
                    <td>{{ __('End Date of the Booking for multi-day bookings') }}</td>
                </tr>
                <tr>
                    <td>{number_of_day}</td>
                    <td>{{ __('Number of Days for the Multi-Day Booking') }}</td>
                </tr>
                <tr>
                    <td>{booking_link}</td>
                    <td>{{ __('Link to View Booking Details') }}</td>
                </tr>
            @endif
            @if ($templateInfo->mail_type == 'hourly_rental_space_booking')
                <tr>
                    <td>{customer_name}</td>
                    <td>{{ __('Customer Name') }}</td>
                </tr>
                ...
                <tr>
                    <td>{start_time}</td>
                    <td>{{ __('Start Time of the Booking for Hourly bookings') }}</td>
                </tr>
                <tr>
                    <td>{end_time}</td>
                    <td>{{ __('End Time of the Booking for Hourly bookings') }}</td>
                </tr>
                <tr>
                    <td>{booking_link}</td>
                    <td>{{ __('Link to View Booking Details') }}</td>
            ...
            @endif
            @if ($templateInfo->mail_type == 'fixed_time_slot_rental_space_booking')
                <tr>
                    <td>{customer_name}</td>
                    <td>{{ __('Customer Name') }}</td>
                </tr>
            ...
            @endif
            @if ($templateInfo->mail_type == 'vendor_space_booking_notification')
                <tr>
                    <td>{vendor_name}</td>
            ...
            @endif
             @if ($templateInfo->mail_type == 'space_booking_rejected')
                <tr>
                    <td>{customer_name}</td>
                    <td>{{ __('Customer Name') }}</td>
                </tr>
            ...
            @endif
            @if ($templateInfo->mail_type == 'quote_request' || $templateInfo->mail_type == 'quote_request_status' || $templateInfo->mail_type == 'tour_request_cancel_status' || $templateInfo->mail_type == 'tour_request_confirm_status' || $templateInfo->mail_type == 'tour_request' || $templateInfo->mail_type == 'quote_request_cancel_status')
                <tr>
                    <td>{customer_name}</td>
                    <td>{{ __('Customer Name') }}</td>
                </tr>
                <tr>
                    ...
                    <td>{{ __('Request Reference Number or Request ID') }}</td>
                </tr>
                <tr>
                    <td>{title}</td>
                    <td>{{ __('Name of the Space') }}</td>
