                            ...
                            <div class="col-lg-6 offset-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="smtp_status" value="1"
                                                   class="selectgroup-input" {{ (!empty($data) && $data->smtp_status == 1) ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="smtp_status" value="0"
                                                   class="selectgroup-input" {{ (!empty($data) && $data->smtp_status == 0) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="smtp_host"
                                           value="{{ !empty($data) ? $data->smtp_host : '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="smtp_port"
                                           value="{{ !empty($data) ? $data->smtp_port : '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="encryption"
                                           value="{{ !empty($data) ? $data->encryption : '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="smtp_username"
                                           value="{{ !empty($data) ? $data->smtp_username : '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="smtp_password"
                                           value="{{ !empty($data) ? $data->smtp_password : '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="from_mail"
                                           value="{{ !empty($data) ? $data->from_mail : '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="from_name"
                                           value="{{ !empty($data) ? $data->from_name : '' }}">
