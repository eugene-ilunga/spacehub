                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input name="ticket_no" type="text" class="form-control"
                                                placeholder="{{ __('Search by Ticket ID') }}"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control " name="ticket_status"
                                                ...
                                                <option value=""
                                                    {{ empty(request()->input('ticket_status')) ? 'selected' : '' }}>
                                                    {{ __('All') }}
                                                </option>
                                                <option value="pending"
                                                    {{ request()->input('ticket_status') == 'pending' ? 'selected' : '' }}>
                                                    {{ __('Pending') }}
                                                </option>
                                                <option value="open"
                                                    {{ request()->input('ticket_status') == 'open' ? 'selected' : '' }}>
                                                    {{ __('Open') }}
                                                </option>
                                                <option value="closed"
                                                    {{ request()->input('ticket_status') == 'closed' ? 'selected' : '' }}>
                                                    {{ __('Closed') }}
                                                </option>
                                            </select>
                                        </div>
                                            ...
                                            @foreach ($tickets as $ticket)
                                                <tr>
                                                    ...
                                                    @if ($ticket->user_type == 'user')
                                                        ...
                                                        @endphp
                                                        <td><span class="badge badge-success">{{ __('Customer') }}</span>
                                                        </td>
                                                        <td><a target="_blank"
                                                    ...
                                                    @else
                                                        ...
                                                        @endphp
                                                        <td><span class="badge badge-success">{{ __('Vendor') }}</span>
                                                        </td>
                                                        <td>
                                                            @if ($seller)
                                                                <a
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                <a href="{{ '#assignModal-' . $ticket->id }}"
                                                                    data-toggle="modal" class="dropdown-item">
                                                                    {{ __('Assign To') }}
                                                                </a>

                                                                <a href="{{ route('admin.support_ticket.conversation', ['id' => $ticket->id, 'language' => $defaultLang->code]) }}"
                                                                    class="dropdown-item">
                                                                    {{ __('Conversation') }}
                                                                </a>
                                                ...
                                                <!-- Assign-admin Modal -->
                                                @includeIf('admin.support-ticket.assign-admin')
                                            @endforeach
                                        </tbody>
                                    </table>
                                </div>
