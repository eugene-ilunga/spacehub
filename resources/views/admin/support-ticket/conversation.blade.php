                            ...
                            @else
                                <div class="messages-container">
                                    @foreach ($conversations as $conversation)
                                        ...
                                        @elseif ($conversation->person_type == 'seller')
                                            ...
                                            <div class="single-message">
                                                <div class="user-details">
                                                    ...
                                                    <div class="user-infos">
                                                        ...
                                                        <span class="type"><i
                                                                class="fas fa-user mr-2"></i>{{ __('Vendor') }}</span>
                                                        <span
                                                            class="badge badge-secondary">{{ $conversation->created_at->format('M d, Y - h:i A') }}</span>
                                                    </div>
                                                </div>
                                        ...
                                        @else
                                            ...
                                            <div class="single-message">
                                                <div class="user-details">
                                                    <div class="user-img">
                                                        <img src="{{ !is_null($user->image) ? asset('assets/img/users/' . $user->image) : asset('assets/img/blank-user.jpg') }}"
                                                    ...
                                                    <div class="user-infos">
                                                        ...
                                                        <span class="type"><i
                                                                class="fas fa-user mr-2"></i>{{ __('Customer') }}</span>
                                                        <span
                                                            class="badge badge-secondary">{{ $conversation->created_at->format('M d, Y - h:i A') }}</span>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p id="attachment-info" class="mt-2 mb-0 text-warning">
                                            {{ '*' . __('Upload only').' ' .'.zip' .' '. __('File') . ' ' . __('Max file size is 20 MB') . '.' }}
                                        </p>
