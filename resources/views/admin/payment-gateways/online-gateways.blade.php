...
@section('content')
    ...
    <div class="row">
        ...
        {{-- freshpay Information --}}
        <div class="col-lg-4">
            <div class="card">
                <form action="{{ route('admin.payment_gateways.update_freshpay_info') }}" method="post">
                    @csrf
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-title">{{ __('Freshpay') }}</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>{{ __('Freshpay Status') }}</label>
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="freshpay_status" value="1" class="selectgroup-input"
                                                {{ $freshpay && $freshpay->status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="freshpay_status" value="0" class="selectgroup-input"
                                                {{ $freshpay && $freshpay->status == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                        </label>
                                    </div>
                                    @if ($errors->has('freshpay_status'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('freshpay_status') }}</p>
                                    @endif
                                </div>

                                @if ($freshpay)
                                    @php $freshpayInfo = json_decode($freshpay->information, true); @endphp
                                @endif

                                <div class="form-group">
                                    <label>{{ __('Merchant Id') }}</label>
                                    <input type="text" class="form-control" name="freshpay_merchant_id"
                                        value="{{ old('freshpay_merchant_id', @$freshpayInfo['merchant_id']) }}">
                                    @if ($errors->has('freshpay_merchant_id'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('freshpay_merchant_id') }}</p>
                                    @endif
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Merchant Secrete') }}</label>
                                    <input type="text" class="form-control" name="freshpay_merchant_secrete"
                                        value="{{ old('freshpay_merchant_secrete', @$freshpayInfo['merchant_secrete']) }}">
                                    @if ($errors->has('freshpay_merchant_secrete'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('freshpay_merchant_secrete') }}</p>
                                    @endif
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Firstname') }}</label>
                                    <input type="text" class="form-control" name="freshpay_firstname"
                                        value="{{ old('freshpay_firstname', @$freshpayInfo['firstname']) }}">
                                    @if ($errors->has('freshpay_firstname'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('freshpay_firstname') }}</p>
                                    @endif
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Lastname') }}</label>
                                    <input type="text" class="form-control" name="freshpay_lastname"
                                        value="{{ old('freshpay_lastname', @$freshpayInfo['lastname']) }}">
                                    @if ($errors->has('freshpay_lastname'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('freshpay_lastname') }}</p>
                                    @endif
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Email') }}</label>
                                    <input type="email" class="form-control" name="freshpay_email"
                                        value="{{ old('freshpay_email', @$freshpayInfo['email']) }}">
                                    @if ($errors->has('freshpay_email'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('freshpay_email') }}</p>
                                    @endif
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                <form action="{{ route('admin.payment_gateways.update_authorizenet_info') }}" method="post">
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-title">{{ __('Authorize') . '.' . __('Net') }}</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="authorizenet_status" value="1"
                                                class="selectgroup-input"
                                                {{ $authorizenet->status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="authorizenet_status" value="0"
                                                class="selectgroup-input"
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('authorizenet_api_login_id'))
                                        <p class="mt-1 mb-0 text-danger">
                                            {{ $errors->first('authorizenet_api_login_id') }}</p>
                                    @endif
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('authorizenet_transaction_key'))
                                        <p class="mt-1 mb-0 text-danger">
                                            {{ $errors->first('authorizenet_transaction_key') }}</p>
                                    @endif
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('authorizenet_public_client_key'))
                                        <p class="mt-1 mb-0 text-danger">
                                            {{ $errors->first('authorizenet_public_client_key') }}</p>
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <a href="//www.awesomescreenshot.com/video/25404126?key=3f7a7fa8cf2391113bb926f43609fa56"
                                ...
                                @if ($paytabs)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="country" id="" class="form-control">
                                            ...
                                            <option value="oman" @selected($paytabsInfo['country'] == 'oman')>{{ __('Oman') }}
                                            </option>
                                            <option value="jordan" @selected($paytabsInfo['country'] == 'jordan')>{{ __('Jordan') }}
                                            </option>
                                            <option value="iraq" @selected($paytabsInfo['country'] == 'iraq')>{{ __('Iraq') }}
                                            </option>
                                        </select>
