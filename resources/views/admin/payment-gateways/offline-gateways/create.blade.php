      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form" action="{{ route('admin.payment_gateways.store_offline_gateway') }}" method="POST">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" placeholder="{{ __('Enter Payment Gateway Name') }}">
          ...
          <div class="form-group">
            ...
            <textarea id="add_summernote" class="form-control summernote" name="instructions" placeholder="{{ __('Enter Gateway Instructions') }}" data-height="150"></textarea>
            <p id="err_instructions" class="mt-2 mb-0 text-danger em"></p>
          </div>
