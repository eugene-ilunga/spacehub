                    ...
                    <div class="row">
                        <div class="col-lg-10 mx-auto">
                            <form id="ajaxEditForm"
                                  action="{{ route('admin.user_management.user.update', ['id' => $user->id]) }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="thumb-preview">
                                                @if (!empty($user->image))
                                                    <img src="{{ asset('assets/img/users/' . $user->image) }}" alt="..."
                                                         class="uploaded-img">
                                                @else
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $user->email_address }}" class="form-control"
                                                   name="email_address" placeholder="{{ __('Enter email address') }}">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <input type="tel" value="{{ $user->phone_number }}" class="form-control" 
