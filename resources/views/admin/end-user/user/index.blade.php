                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 offset-lg-2">
                            <button type="button" class="btn btn-primary float-right   btn-sm ml-2 mt-1  "
                            ...
                            <form class="float-right" action="{{ route('admin.user_management.registered_users') }}"
                                method="GET">
                                <input type="hidden" name="language" value="{{ $defaultLang->code }}">

                                <input name="info" type="text" class="form-control min_width_230"
                                        ...
                                        <tbody>
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form id="emailStatusForm-{{ $user->id }}"
                                                            ...
                                                            <select
                                                                ...
                                                                <option value="verified"
                                                                    {{ !is_null($user->email_verified_at) ? 'selected' : '' }}>
                                                                    {{ __('Verified') }}
                                                                </option>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                <a href="{{ route('admin.user_management.user.details', ['id' => $user->id, 'language' => $defaultLang->code]) }}"
                                                                    class="dropdown-item">
                                                                    {{ __('Details') }}
                                                                </a>
                                                                <a href="{{ route('admin.user_management.user.edit', ['id' => $user->id, 'language' => $defaultLang->code]) }}"
                                                                    class="dropdown-item">
                                                                    {{ __('Edit') }}
                                                                </a>

                                                                <a href="{{ route('admin.user_management.user.change_password', ['id' => $user->id, 'language' => $defaultLang->code]) }}"
                                                                    class="dropdown-item">
                                                                    {{ __('Change Password') }}
                                                                </a>
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.user_management.register_user') }}" method="POST" id="ajaxForm">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="username" placeholder="{{ __('Enter username') }}">
                            <p id="err_username" class="text-danger mb-0 em"></p>
                        </div>
                        <div class="form-group">
                            <label for="">{{ __('Email') }} *</label>
                            <input class="form-control" type="email" name="email_address" placeholder="{{ __('Enter email address') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="password" name="password_confirmation" placeholder="{{ __('Enter confirm password') }}">
