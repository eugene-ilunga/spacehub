            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        <form id="ajaxEditForm" action="{{ route('admin.end-user.vendor.add.save') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="vendor_creation">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="alert alert-danger pb-1 dis-none" id="VendorCreationErrors">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" value="" class="form-control {{ $adminLanguage->direction == 1 ? 'rtl' : 'ltr'}}" name="phone"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                                        ...
                                                        <textarea name="{{ $language->code }}_address"
                                                            class="form-control"
                                                    ...
                                                    <div class="form-check py-0">
                                                        <label class="form-check-label">
                                                            ...
                                                            <span class="form-check-sign">{{ __('Clone for') }}
                                                                <strong class="text-capitalize text-secondary">{{
