        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card-title">{{ __('Registered Vendors') }}</div>
                        </div>

                        <div class="col-lg-3">
                            <button class="btn btn-danger btn-sm float-right d-none bulk-delete mr-2 ml-3 mt-1"
                                data-href="{{ route('admin.end-user.vendor.bulk_delete') }}">
                                <i class="flaticon-interface-5"></i> {{ __('Delete') }}
                            </button>
                        </div>

                        <div class="col-lg-3">
                            <form class="float-right w-100" action="{{ route('admin.end-user.vendor.registered_vendor') }}"
                                method="GET">
                                        ...
                                        <tbody>
                                            @foreach ($sellers as $seller)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form id="accountStatusForm-{{ $seller->id }}"
                                                            class="d-inline-block"
                                                            action="{{ route('admin.end-user.vendor.update_account_status', ['id' => $seller->id]) }}"
                                                            method="post">
                                                            @csrf
                                                            <select
                                                    ...
                                                    <td>
                                                        <form id="emailStatusForm-{{ $seller->id }}"
                                                            class="d-inline-block"
                                                            action="{{ route('admin.end-user.vendor.update_email_status', ['id' => $seller->id]) }}"
                                                            method="post">
                                                            @csrf
                                                            <select
                                                                ...
                                                                <option value="1"
                                                                    {{ $seller->email_verified_at != null ? 'selected' : '' }}>
                                                                    {{ __('Verified') }}
                                                                </option>
                                                                <option value="0"
                                                                    {{ $seller->email_verified_at == null ? 'selected' : '' }}>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                <a href="{{ route('admin.end-user.vendor.details', ['id' => $seller->id, 'language' => $defaultLang->code]) }}"
                                                                    class="dropdown-item">
                                                                    {{ __('Details'). ' & '  .__('Package') }}
                                                                </a>

                                                                <a href="{{ route('admin.end-user.vendor.edit', ['id' => $seller->id, 'language' =>$defaultLang->code]) }}"
                                                                    class="dropdown-item">
                                                                    {{ __('Edit') }}
                                                                </a>

                                                                <a href="{{ route('admin.end-user.vendor.change_password', ['id' => $seller->id]) }}"
                                                                    class="dropdown-item">
                                                                    {{ __('Change Password') }}
                                                                </a>

                                                                <form class="deleteForm d-block"
                                                                    action="{{ route('admin.end-user.vendor.delete', ['id' => $seller->id]) }}"
                                                                    method="post">
                                                                    @csrf
                                                                ...
                                                                <a target="_blank"
                                                                    href="{{ route('admin.end-user.vendor.secret_login', ['id' => $seller->id]) }}"
                                                                    class="dropdown-item">
                                                                    {{ __('Secret Login') }}
                                                                </a>
                                                            </div>
