                    ...
                    <div class="row">
                        <div class="col-lg-10 mx-auto">
                            <form id="ajaxEditForm"
                                action="{{ route('admin.end-user.vendor.update_vendor', ['id' => $seller->id]) }}"
                                method="post">
                                @csrf
                                <h2>{{ __('Details') }}</h2>
                                <hr>
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="thumb-preview">
                                                @if ($seller->photo != null)
                                                    <img src="{{ asset('assets/admin/img/seller-photo/' . $seller->photo) }}"
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <p class="mt-2 mb-0 text-warning">{{ __('Image Size') . ': ' . '100x100' }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $seller->username }}" class="form-control"
                                                name="username">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $seller->email }}" class="form-control"
                                                name="email">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $seller->recipient_mail }}"
                                                class="form-control" name="recipient_mail">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" value="{{ $seller->phone }}" class="form-control {{ $adminLanguage->direction == 1 ? 'rtl' : 'ltr'}}"
                                                name="phone">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox"
                                                            {{ $seller->show_email_addresss == 1 ? 'checked' : '' }}
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox"
                                                            {{ $seller->show_phone_number == 1 ? 'checked' : '' }}
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox"
                                                            {{ $seller->show_contact_form == 1 ? 'checked' : '' }}
                                        ...
                                        <div id="accordion" class="mt-5">
                                            @foreach ($languages as $language)
                                                <div class="version {{ $language->direction == 1 ? 'rtl' : 'ltr'  }}">
                                                    ...
                                                    @php
                                                        $sellerInfo = App\Models\SellerInfo::where(
                                                            'seller_id',
                                                            $seller->id,
                                                        )
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                                                        <label>{{ __('Name') . '*' }}</label>
                                                                        <input type="text"
                                                                            value="{{ !empty($sellerInfo) ? $sellerInfo->name : '' }}"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                                                        ...
                                                                        <input type="text"
                                                                            value="{{ !empty($sellerInfo) ? $sellerInfo->country : '' }}"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                                                        <label>{{ __('City') }}</label>
                                                                        <input type="text"
                                                                            value="{{ !empty($sellerInfo) ? $sellerInfo->city : '' }}"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                                                        ...
                                                                        <input type="text"
                                                                            value="{{ !empty($sellerInfo) ? $sellerInfo->state : '' }}"
                                                                            class="form-control"
                    ...
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <h2 class="mt-3 text-warning">{{ __('Vendor Balance') . ' : ' }}
                                {{ $seller->amount == null ? 0.00 : symbolPrice($seller->amount) }}</h2>
                            <hr>
                            <form id="ajaxEditForm2"
                                action="{{ route('admin.end-user.vendor.update_vendor_balance', ['id' => $seller->id]) }}"
                                method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="selectgroup w-100">
                                                <label class="selectgroup-item">
                                                    <input type="radio" name="amount_status" value="1"
                                                        class="selectgroup-input">
                                                    <span class="selectgroup-button">{{ __('Add') }}</span>
                                                </label>
                                                <label class="selectgroup-item">
                                                    <input type="radio" name="amount_status" value="0"
                                                        class="selectgroup-input">
