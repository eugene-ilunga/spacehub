    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Update Space Ammenity') }}</h5>
            ...
            <div class="modal-body">
                <form id="ajaxEditForm" class="modal-form"
                    action="{{ route('admin.space_management.amenities.update') }}" method="post">
                    @csrf
                    <input type="hidden" id="in_id" name="id">
                    <input type="hidden" id="in_language" name="language">

                    <div class="form-group">
                        <label for="">{{ __('Space Amenities Icon') . '*' }}</label>
                    ...
                    <div class="form-group">
                        <label for="">{{ __('Amenity Name') . '*' }}</label>
