    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Space Amenity') }}</h5>
            ...
            <div class="modal-body">
                <form id="ajaxForm" class="modal-form"
                    action="{{ route('admin.space_management.amenities.store', ['language' => $defaultLang->code]) }}"
                    method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="">{{ __('Amenity Icon') . '*' }}</label>
