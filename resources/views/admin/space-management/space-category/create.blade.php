    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Space Category') }}</h5>
            ...
            <div class="modal-body">
                <form id="ajaxForm" class="modal-form create"
                    action="{{ route('admin.space_management.space-category.store') }}" method="post">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p class="text-warning mt-2">{{ __('Image Size') . ':' }} <span
                                        dir="ltr">{{ '70 x 70 px' }}</span></p>
                                <p id="err_icon_image" class="mt-2 mb-0 text-danger em"></p>
                            </div>
                        </div>
                        @if ($themeVersion->theme_version == 2)
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <p id="err_bg_image" class="mt-2 mb-0 text-danger em"></p>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <p id="err_category_description" class="mt-2 mb-0 text-danger em"></p>
                            </div>
                        </div>
                    </div>
