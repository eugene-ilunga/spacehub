            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block"
                        href="{{ route('admin.space_management.service.view_services', ['space_id' => request()->space_id, 'language' => $defaultLang->code]) }}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form id="serviceForm"
                                action="{{ isset($spaceService->id) ? route('admin.space_management.service.update', ['id' => $spaceService->id]) : '#' }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="price_type" class="form-control">
                                                ...
                                                <option value="per person"
                                                    {{ $spaceService->price_type == 'per person' ? 'selected' : '' }}>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table space-sub_service_table table-bordered ">
                                                ...
                                                <tbody>
                                                        ...
                                                        @foreach ($subServices as $subService)
                                                            <tr id="subservice-row-{{ $subService->id }}">
                                                                ...
                                                                <td>
                                                                    @foreach ($languages as $language)
                                                                        @php
                                                                            $subServiceContent = $subService
                                                                                ->subServiceContents()
                                                                                ->where('language_id', $language->id)
                                                                                ->first();
                                                                            $title = $subServiceContent->title ?? null;
                                                                        @endphp
                                                                        @if (!empty($title))
                                                                            <div class="form-group">
                                                                                <label
                                                                                ...
                                                                                <input type="text"
                                                                                    ...
                                                                                    class="form-control {{ $language->direction == 1 ? 'rtl text-right' : 'ltr'  }}"
                                                                                    value="{{ $title }}"
                                                    ...
                                                    @else
                                                        <tr>
                                                            <td colspan="5">{{ __('NO VARIANTS FOUND') . '!' }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                </tbody>
...
@section('script')
    <script>
        ...
        var deleteSubServiceUrl = "{{ route('admin.space_management.service.stored_sub_service_delete') }}";
        var imageRmvUrl = "{{ route('admin.subservice.image.remove') }}";
    </script>
