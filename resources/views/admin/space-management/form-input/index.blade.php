                    ...
                    <div class="col">
                        ...
                        <div id="sort-content">
                            ...
                            <form class="ui-state-default"
                                action="{{ route('admin.space-management.form.delete_input', ['id' => $inputField->id]) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-lg-1">
                                            <a href="{{ route('admin.space-management.form.edit_input', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => request()->input('language')]) }}"
                            ...
                            <form class="ui-state-default"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-lg-1">
                                            <a href="{{ route('admin.space-management.form.edit_input', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => $defaultLang->code]) }}"
                                                class="btn btn-sm btn-secondary mt-1">
                                                <i class="fas fa-edit text-white "></i>
                                            </a>
                                        </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('admin.space-management.form.index', ['language' => $defaultLang->code]) }}"
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <form id="ajaxForm"
                            action="{{ route('admin.space-management.form.store_input', ['id' => $form->id]) }}"
                            method="POST">
                            @csrf
...
<script type="text/javascript">
    let optArr = {!! json_encode([]) !!};
        ...
        const sortURL = "{{ route('admin.space-management.form.sort_input') }}";
</script>
