...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a
                    href="{{ route('admin.space-management.form.index', ['language' => $defaultLang->code]) }}">{{ __('Forms') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <a href="{{ route('admin.space-management.form.input', ['id' => request()->route('form_id'), 'language' => $defaultLang->code]) }}"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <form id="ajaxEditForm"
                                action="{{ route('admin.space-management.form.update_input', ['id' => $inputField->id]) }}"
                                method="POST">
                                @csrf
