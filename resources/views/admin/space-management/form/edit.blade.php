    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.space-management.update_form') }}"
                    method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select name="seller_id" id="in_seller_id" class="select2">
                        ...
                        <p id="editErr_seller_id" class="mt-2 mb-0 text-danger em"></p>
                    </div>
