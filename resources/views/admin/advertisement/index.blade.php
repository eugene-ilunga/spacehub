                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($ad->resolution_type == 1)
                                                            <span dir="ltr">300 x 250</span>
                                                        @elseif ($ad->resolution_type == 2)
                                                            <span dir="ltr">300 x 600</span>
                                                        @elseif($ad->resolution_type == 3)
                                                            <span dir="ltr">728 x 90</span>
                                                        @elseif($ad->resolution_type == 4)
                                                            <span dir="ltr">370 x 250</span>
                                                        @else
                                                            <span dir="ltr">370 x 600</span>
                                                        @endif
                                                    </td>
                                                    <td>
