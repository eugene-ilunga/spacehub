            ...
            <div class="modal-body">
                <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.advertise.update_advertisement') }}"
                    ...
                    <div class="form-group">
                        ...
                        <select name="resolution_type" class="form-control always-ltr" id="in_resolution_type">
                            <option disabled>{{ __('Select a Resolution') }}</option>
                            <option value="1">300 x 250</option>
                            <option value="4">370 x 250</option>
                            <option value="5">370 x 600</option>
                    ...
                    <div class="form-group d-none" id="edit-slot-input">
                        ...
                        <p class="mt-2 mb-0">
                            <a href="//prnt.sc/1uwa420" target="_blank"
                               class="redirect-link">{{ __('Click Here') }}</a> {{ __('to see where you can find the ad slot') . 'simple-cache' }}
                        </p>
                    </div>
                </form>
            </div>
