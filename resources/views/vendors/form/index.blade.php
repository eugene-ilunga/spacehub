...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <form action="{{ route('vendor.space_management.form.index') }}" method="GET">
                                            ...
                                            @if (isset($forms) && $forms->isNotEmpty())
                                                @foreach ($forms as $form)
                                                    <tr>
                                                        ...
                                                        <td>{{ @$form->name }}</td>
                                                        <td>
                                                            <a @if ($data['status'] == 'true') href="{{ route('vendor.space_management.form-input.index', ['id' => $form->id, 'language' => $defaultLang->code]) }}" @endif
                                                        ...
                                                        <td>
                                                            ...
                                                            <form class="deleteForm d-inline-block"
                                                                action="{{ route('vendor.space_management.form-input.delete_form', ['id' => $form->id]) }}"
                                                                method="post">
                                                                @csrf
                                                                <button type="submit"
    ...
    {{-- create modal --}}
    @includeIf('vendors.form.create')

    {{-- edit modal --}}
    @includeIf('vendors.form.edit')
@endsection
