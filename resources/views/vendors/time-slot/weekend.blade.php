                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form id="scheduleDay{{ $day->id }}" class="d-inline-block"
                                                        action="{{ route('vendor.manage_schedule.time_slot.update_weekend', ['id' => $day->id]) }}"
                                                        method="post">
                                                        @csrf
                                                        <input type="hidden" name="seller_id" value="{{ $seller_id }}">
                                                        @if ($currentPackage == null)
                                                            <select
                                                                class="form-control form-control-sm disabled {{ $day->is_weekend == 1 ? 'bg-success' : 'bg-danger' }}"
