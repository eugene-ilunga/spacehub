      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-2">
              <a href="{{ route('vendor.space_management.form-input.index', ['id' => request()->route('form_id'), 'language' => request()->input('language')]) }}"
          ...
          <div class="row justify-content-center">
            <div class="col-lg-6">
              <form id="ajaxEditForm"
                action="{{ route('vendor.space_management.form-input.update', ['id' => $inputField->id]) }}"
                method="POST">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="label" placeholder="{{ __('Enter Input Label') }}"
                ...
                @if ($inputField->type != 4 && $inputField->type != 8)
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="placeholder" placeholder="{{ __('Enter Input Placeholder') }}"
                ...
                @if ($inputField->type == 3 || $inputField->type == 4)
                  ...
                  <div class="row no-gutters" v-for="(option, index) in optionsArray" v-bind:key="index">
                    <div class="col-lg-10">
                      <div class="form-group">
                        <input type="text" class="form-control" name="options[]" placeholder="{{ __('Enter Option') }}"
                          v-bind:value="option">
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="number" step="0.01" class="form-control ltr" name="file_size"
                        placeholder="{{ __('Enter File Size') }}" value="{{ $inputField->file_size }}">
