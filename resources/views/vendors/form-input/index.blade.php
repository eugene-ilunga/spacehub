...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a
                    href="{{ route('vendor.space_management.form.index', ['language' => $defaultLang->code]) }}">{{ __('Forms') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
                    ...
                    <div class="row">
                        <div class="col">
                            <p class="text-warning">
                                {{ '*' . __('Do not create') }} <span
                                    class="text-info">{{ __('Name, Email & Phone Number') }}</span>
                                    ...
                                    @foreach ($inputFields as $inputField)
                                        @if ($inputField->type == 1)
                                            <form class="ui-state-default"
                                                action="{{ route('vendor.space_management.form-input.delete', ['id' => $inputField->id]) }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row no-gutters">
                                                        ...
                                                        <div class="col-lg-1">
                                                            <a href="{{ route('vendor.space_management.form-input.edit', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => request()->input('language')]) }}"
                                            ...
                                            <form class="ui-state-default"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row no-gutters">
                                                        ...
                                                        <div class="col-lg-1">
                                                            <a href="{{ route('vendor.space_management.form-input.edit', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => $defaultLang->code]) }}"
                                                                class="btn btn-sm btn-secondary mt-1">
                                                                <i class="fas fa-edit text-white "></i>
                                                            </a>
                                                        </div>
                                        ...
                                        @elseif ($inputField->type == 6)
                                            <form class="ui-state-default"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row no-gutters">
                                                        <div class="col-lg-9 mr-3">
                                                            <input type="text" class="form-control checkInDateNotBooking"
                                                                name="{{ $inputField->name }}"
                                        ...
                                        @else
                                            <form class="ui-state-default"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row no-gutters">
                                                        <div class="col-lg-9 mr-3">
                                                            <input type="file" name="{{ $inputField->name }}"
                                                                class="ltr">
                                                        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <a href="{{ route('vendor.space_management.form.index', ['language' => $defaultLang->code]) }}"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <form id="ajaxForm"
                                action="{{ route('vendor.space_management.form-input.store', ['id' => $form->id]) }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline pl-0">
                                        ...
                                        <label class="form-check-label mt-2"
                                            for="input-type-1">{{ __('Text Field') }}</label>
                                    </div>
                                    ...
                                    <div class="form-check form-check-inline pl-0">
                                        ...
                                        <label class="form-check-label mt-2"
                                            for="input-type-2">{{ __('Number Field') }}</label>
                                    </div>
                                    ...
                                    <div class="form-check form-check-inline pl-0">
                                        ...
                                        <label class="form-check-label mt-2"
                                            for="input-type-3">{{ __('Select') }}</label>
                                    </div>
                                    ...
                                    <div class="form-check form-check-inline pl-0">
                                        ...
                                        <label class="form-check-label mt-2"
                                            for="input-type-4">{{ __('Checkbox') }}</label>
                                    </div>
                                    ...
                                    <div class="form-check form-check-inline pl-0">
                                        ...
                                        <label class="form-check-label mt-2"
                                            for="input-type-5">{{ __('Textarea') }}</label>
                                    </div>
                                    ...
                                    <div class="form-check form-check-inline pl-0">
                                        ...
                                        <label class="form-check-label mt-2"
                                            for="input-type-6">{{ __('Datepicker') }}</label>
                                    </div>
                                    ...
                                    <div class="form-check form-check-inline pl-0">
                                        ...
                                        <label class="form-check-label mt-2"
                                            for="input-type-7">{{ __('Timepicker') }}</label>
                                    </div>
                                    ...
                                    <div class="form-check form-check-inline pl-0">
                                        ...
                                        <label class="form-check-label mt-2"
                                            for="input-type-8">{{ __('File') }}</label>
                                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        const sortURL = "{{ route('vendor.space_management.form-input.sort_input') }}";
    </script>
