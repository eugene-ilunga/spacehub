        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control mdb_343" name="payment_gateway">
                                            ...
                                            <option value="{{ $onlineGateway->keyword }}" {{ request()->input('payment_gateway') == $onlineGateway->keyword ? 'selected' : ''
                                                }}>
                                            ...
                                            <option value="{{ $offlineGateway->name }}" {{ request()->
                                                input('payment_gateway') == $offlineGateway->name ? 'selected' : '' }}>
                                                {{ $offlineGateway->name }}
                                            </option>
                                            @endforeach
                                            @endif
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control mdb_343" name="payment_status">
                                            ...
                                            <option value="completed" {{ request()->input('payment_status') ==
                                                'completed' ? 'selected' : '' }}>
                                                {{ __('Completed') }}
                                            </option>
                                            <option value="pending" {{ request()->input('payment_status') == 'pending' ?
                                                'selected' : '' }}>
                                                {{ __('Pending') }}
                                            </option>
                                            <option value="rejected" {{ request()->input('payment_status') == 'rejected'
                                                ? 'selected' : '' }}>
                                                {{ __('Rejected') }}
                                            </option>
                                        </select>
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control mdb_343" name="booking_status">
                                            ...
                                            <option value="pending" {{ request()->input('booking_status') == 'pending' ?
                                                'selected' : '' }}>
                                                {{ __('Pending') }}
                                            </option>
                                            <option value="approved" {{ request()->input('booking_status') == 'approved'
                                                ? 'selected' : '' }}>
                                                {{ __('Approved') }}
                                            </option>
                                            <option value="rejected" {{ request()->input('booking_status') == 'rejected'
                                                ? 'selected' : '' }}>
                                                {{ __('Rejected') }}
                                            </option>
                                        </select>
                    ...
                    <div class="col-lg-2">
                        <a href="{{ route('vendor.booking_record.export_report') }}"
                            ...
                            <table class="table table-striped mt-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ strlen($order->space_title) > 20 ? mb_substr($order->space_title, 0, 20,
                                            'UTF-8') . '...' : $order->space_title }}
                                        </td>
                                        @php
                                        ...
                                        <td>
                                            ...
                                            }}{{ $order->tax }}{{ $order->currency_symbol_position == 'right' ?
                                        ...
                                        <td>
                                            ...
                                            @else
                                            {{ $order->currency_symbol_position == 'left' ? $order->currency_symbol : ''
                                            }}{{ $order->grand_total }}{{ $order->currency_symbol_position == 'right' ?
                                            $order->currency_symbol : '' }}
                                            @endif
                                        </td>
                                        ...
                                        @php
                                        $bookngDate = Carbon\Carbon::parse($order->created_at)->format(
                                        'M d, Y',
                                        );
                                        @endphp
                                        <td>{{ $bookngDate }}</td>
...
@include('vendors.booking-management.report-details')
@endsection
