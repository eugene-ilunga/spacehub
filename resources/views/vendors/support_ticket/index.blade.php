                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <form action="" class="" method="GET">
                                ...
                                <input type="text" name="ticket_id"
                                       class="form-control float-lg-right float-left min-w-250"
                        ...
                        <div class="col-lg-4">
                            ...
                            <button class="btn btn-danger float-right mb-1 btn-sm mt-1 bulk-delete d-none"
                                    data-href="{{ route('vendor.support_tickets.bulk_delete') }}"><i
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            ...
                                                            <a href="{{ route('vendor.support_ticket.message', $item->id) }}"
                                                               class="dropdown-item">
                                                                {{ __('Message') }}
                                                            </a>
                                                            <form class="deleteForm d-block"
                                                                  action="{{ route('vendor.support_tickets.delete', $item->id) }}"
                                                                  method="post">
                                                                @csrf
