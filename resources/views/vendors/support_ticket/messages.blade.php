...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{ route('vendor.support_ticket') }}">{{ __('All Tickets') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block" href="{{ route('vendor.support_ticket') }}">
                                    ...
                                    @foreach ($conversations as $conversation)
                                        @if ($conversation->person_type == 'admin')
                                            ...
                                            <div class="single-message">
                                                <div class="user-details">
                                                    <div class="user-img">
                                                        <img src="{{ !is_null($admin->image) ? asset('assets/img/admins/' . $admin->image) : asset('assets/img/blank-user.jpg') }}"
                                        ...
                                        @else
                                            ...
                                            <div class="single-message">
                                                <div class="user-details">
                                                    <div class="user-img">
                                                        <img src="{{ !is_null($seller->photo) ? asset('assets/admin/img/seller-photo/' . $seller->photo) : asset('assets/frontend/images/vendor/vendor.png') }}"
                                                            alt="{{ $seller->username }}">
                                                    </div>
                                                    ...
                                                    <div class="user-infos">
                                                        ...
                                                        <span class="type"><i
                                                                class="fas fa-user mr-2"></i>{{ __('Seller') }}</span>
                                                        <span
                                                            class="badge badge-secondary">{{ $conversation->created_at->format('M d, Y - h:i A') }}</span>
                                                    </div>
                                                </div>
        ...
        @if ($ticket->status == 'open')
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="replyForm" action="{{ route('vendor.support_ticket.reply', ['id' => $ticket->id]) }}"
...
@section('script')
    <script src="{{ asset('assets/admin/js/support-ticket.js') }}"></script>
@endsection
