            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block"
                        href="{{ route('vendor.space_management.service.view_from_space', ['space_id' => request()->id, 'language' => $defaultLang->code]) }}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form id="serviceForm" action="{{ route('vendor.space_management.service.store') }}"
