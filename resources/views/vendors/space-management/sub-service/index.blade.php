    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Option Information') }}
                </h5>
            ...
            @php
                ...
                $subservices = DB::table('sub_services')
                    ...
                    ->where([['sub_services.service_id', $service->id], ['sub_service_contents.language_id', $language->id]])
                    ->get();
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (empty($subservices))
                                <h3 class="text-center mt-2">{{ __('NO SUBSERVICES FOUND') . '!' }}</h3>
                            @else
