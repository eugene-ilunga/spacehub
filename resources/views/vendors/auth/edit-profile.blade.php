                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            ...
                            <form id="serviceForm" action="{{ route('vendor.update_profile') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $seller->email }}" class="form-control"
                                                name="email" id="vendorEmailField">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" value="{{ $seller->phone }}"
                                                class="form-control {{ $defaultLang->direction == 1 ? 'rtl' : '' }}"
                                                name="phone">
                                            ...
                                            @foreach ($languages as $language)
                                                <div class="version {{ $language->direction == 1 ? 'rtl text-right' : 'ltr' }}">
                                                    <div class="version-header" id="heading{{ $language->id }}">
                                                        <h5 class="mb-0">
                                                            <button type="button" class="btn btn-link {{ $language->direction == 1 ? 'rtl text-right' : 'ltr'  }}"
                                                    ...
                                                    @php
                                                        $seller_info = App\Models\SellerInfo::where(
                                                            'seller_id',
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div
                                                                        ...
                                                                        <p class="mt-2 mb-0 text-danger em"
                                                                            id="editErr_{{ $language->code }}_name"></p>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div
                                                                        ...
                                                                        <textarea name="{{ $language->code }}_address" class="form-control" placeholder="{{ __('Enter Address') }}">{{ $seller_info ? $seller_info->address : '' }}</textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-12">
                                                                    <div
                                                                        ...
                                                                        <textarea name="{{ $language->code }}_details" rows="5" class="form-control"
                                                                            placeholder="{{ __('Write your text') }}">{{ $seller_info ? $seller_info->details : '' }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
