...
class User extends Authenticatable
{
  ...
  {
    return $this->hasMany(SpaceBooking::class, 'user_id', 'id');
  }
  public function spaceReview()
  {
    return $this->hasMany(SpaceReview::class, 'user_id', 'id');
  }
  ...
  public function spaceWishlisted()
  {
    return $this->hasMany(SpaceWishlist::class, 'user_id', 'id');
  }
