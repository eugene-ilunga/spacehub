...
class PopupController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    $information['popups'] = $language->announcementPopup()->orderByDesc('id')->paginate(10);
  ...
  public function store(StoreRequest $request)
  {
    ...
    $request->session()->flash('success', __('New popup added successfully') . '!');
  ...
  public function updateStatus(Request $request, $id)
  {
    ...
    if ($request->status == 1) {
      ...
      $request->session()->flash('success', __('Popup activated successfully') . '!');
    } else {
      $popup->update(['status' => 0]);

      $request->session()->flash('success', __('Popup deactivated successfully') . '!');
    }
  ...
  public function edit(Request $request, $id)
  {
    ...
    $information['popup'] = Popup::query()->findOrFail($id);

    return view('admin.popup.edit', $information);
  }
  ...
  public function update(UpdateRequest $request, $id)
  {
    ...
    if ($request->hasFile('image')) {
      ...
      $oldImg = $popup->image;
      $imageName = UploadFile::update('./assets/img/popups/', $newImg, $oldImg);
    }
    ...
    $request->session()->flash('success', __('Popup updated successfully') . '!');
  ...
  public function bulkDestroy(Request $request)
  {
    ...
    $request->session()->flash('success', __('Popups deleted successfully') . '!');
