...
use App\Http\Requests\FormInput\StoreRequest;
use App\Http\Requests\FormInput\UpdateRequest;
use App\Models\Form;
...
class FormInputController extends Controller
{
  public function manageInput($id, Request $request)
  {
    ...
    return view('admin.space-management.form-input.index', $information);
  }
  ...
  {
    $information['language'] = getAdminLanguage();
    ...
    return view('admin.space-management.form-input.edit', $information);
  }
