...
class AddBookingController extends Controller
{
    ...
    {
        $sellers = Seller::join('memberships', 'sellers.id', '=', 'memberships.seller_id')
            ->where([
        ...
        $information['spaces'] = Space::query()
            ...
            ->get();
        return view('admin.add-booking.space_selection', $information);
    }
    ...
    public function index(Request $request)
    {
        ...
        $data['sellerId'] = $request->seller_id ?? null;
        ...
        if (!empty($spaceContent) && $spaceContent->space_type == 3) {
            ...
            $spaceBookings = $this->getBookedDateForMultiDay($space->id, $quantity);
        }
        ...
        if (!empty($spaceContent)) {
            ...
            if (!empty($data['serviceContentsWithSubservice'])) {
                ...
                return view('admin.add-booking.add_booking', $data);
            }
        }
    }
