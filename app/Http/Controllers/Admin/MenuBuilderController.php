  ...
  public function index(Request $request)
  {
    ...
    if (is_null($websiteMenuInfo)) {
      ...
      $websiteMenuInfo = MenuBuilder::create([
        ...
        {"text":"Shop","href":"","icon":"empty","target":"_self","title":"","type":"custom","children":
          [{"text":"Shop","href":"","icon":"empty","target":"_self","title":"","type":"shop"},
          {"text":"Cart","href":"shop/cart","icon":"empty","target":"_self","title":"","type":"shop/cart"},
          {"text":"Checkout","href":"","icon":"empty","target":"_self","title":"","type":"shop/checkout"}]},
