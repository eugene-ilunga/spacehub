...
class RolePermissionController extends Controller
{
  ...
  {
    $roles = RolePermission::query()->orderByDesc('id')->paginate(10);
  ...
  public function store(Request $request)
  {
    ...
    $request->session()->flash('success', __('New role added successfully') . '!');
  ...
  public function updatePermissions(Request $request, $id)
  {
    ...
    $request->session()->flash('success', __('Permissions updated successfully') . '!');
