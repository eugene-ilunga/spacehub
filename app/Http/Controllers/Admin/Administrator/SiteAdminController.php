...
class SiteAdminController extends Controller
{
  ...
  public function store(StoreRequest $request)
  {
    ...
    $request->session()->flash('success', __('New staff added successfully') . '!');
  ...
  public function update(UpdateRequest $request)
  {
    ...
    $request->session()->flash('success', __('Staff updated successfully') . '!');
  ...
  public function destroy($id)
  {
    ...
    return redirect()->back()->with('success', __('Staff deleted successfully') . '!');
  }
}
