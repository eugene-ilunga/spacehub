...
class ImageMimeTypeRule implements Rule
{
  ...
  public function passes($attribute, $value)
  {
    ...
    if (
      ...
      URL::current() == Route::is('admin.basic_settings.general_setting') ||
  ...
  public function message()
  {
    if (
      ...
      return __('Only') . ' .jpg, .jpeg, .png, .svg and .gif ' . __('file is allowed') . '.';
    } else {
      return __('Only') . ' .jpg, .jpeg and .png ' . __('file is allowed') . '.' ;
    }
  }
}
